...
test('one concept gets one tag: agreements and the record guide agree', () => {
  ...
  for (const language of ['en', 'tr']) {
    ...
    const agreements = tagOf(notes['Claudian Working agreements.md']);
    const guide = tagOf(notes['Claudian Record Guide.md']);
